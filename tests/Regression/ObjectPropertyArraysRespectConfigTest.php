...
it('honours an explicitly enabled trailing comma for arrays nested in readonly objects', function (): void {
    $object = new ArrayHoldingObject([1, 2, 3]);
    $config = readonlyObjectConfig(ExportConfig::pretty()->withTrailingComma());
    $code = Export::var($object, $config);
