...
it('exports an arrow function whose attribute and static modifier precede fn', function (): void {
...
it('exports a closure whose multiline attribute and static modifier precede function', function (): void {
...
it('preserves nested attributed closure magic names using the runtime declaration line', function (): void {
    ...
    try {
        file_put_contents(
            $file,
            "<?php\n#[\\Attribute(\\Attribute::TARGET_FUNCTION)]\nclass {$attribute} {}\nreturn static function (): Closure {\n    return #[{$attribute}]\n    static\n    fn(): array => [__FUNCTION__, __METHOD__];\n};\n",
        );
        /** @var Closure $outer */
        $outer = require $file;
        /** @var Closure $inner */
